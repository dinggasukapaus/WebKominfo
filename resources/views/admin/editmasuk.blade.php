...
<head>
  ...
  <title>Edit Surat Masuk| Starter</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Data Surat Masuk</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('in')}}">Surat Masuk</a></li>
                ...
                @csrf
                    <div class="post-preview">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="AlamatPengirim" required value="{{$item->AlamatPengirim}}">
                        </div>
                        <div class="form-group">
                            <label>Nomor Surat</label>
                            <input type="text" class="form-control" name="NomorSurat" required value="{{$item->NomorSurat}}">
                        </div>
                        <div class="form-group">
                            <label>Perihal</label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="oldimg" class="d-none" value="{{$item->Foto}}">
                          <img src="{{$item->getImages()}}" class="w-25">
                    ...
                    <div class="clearfix">
                      ...
                      <a class="btn btn-secondary float-right" href="{{route('in')}}">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
